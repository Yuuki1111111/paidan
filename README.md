...
- 录入稿件：项目名、客户、业务分类、制作阶段、来源、手续费方式、平台抽成、优先级、稿费、截稿日期、状态、异常类型、备注
- 业务分类：默认提供头像 / 胸插 / QQ人 / 摸鱼页 / 半身插 / 氛围插 / 全身插 / 立绘 / 人设等常用项，也支持手动输入自定义分类
- 制作阶段：默认提供草稿 / 线稿 / 铺色 / 细化 / 完稿，也支持手动输入色草等自定义阶段
- 重复录单：支持“重复上一单”和按行复制，减少反复手填
- 收款管理：记录已收金额、区分未收款 / 已收定金 / 已结清
- 平台手续费：支持默认按比例，也支持区分米画师企划邀请（按到手价反推报价）和米画师橱窗（满20减1）
...
这些新字段分别用于制作阶段记录、异常处理记录、退款联动，以及区分米画师企划邀请 / 橱窗等不同手续费计算方式。
